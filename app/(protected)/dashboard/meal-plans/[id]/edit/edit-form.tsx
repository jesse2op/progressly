...
import { updateMealPlan } from '@/app/lib/actions/meal-plan';
...
export default function EditMealPlanForm({ planId, initialTitle, initialMeals }: EditMealPlanFormProps) {
    const updateMealPlanWithId = updateMealPlan.bind(null, planId);
    const [errorMessage, dispatch] = useActionState(updateMealPlanWithId, undefined);

    const [title, setTitle] = useState(initialTitle);
    const [meals, setMeals] = useState<Meal[]>(initialMeals.length > 0 ? initialMeals : [
    ...
    return (
        <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-2">
                <h1 className="text-4xl font-black tracking-tight text-gray-900 dark:text-zinc-100">Edit Meal Plan</h1>
                <p className="text-gray-500">Update your nutrition template and save changes.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                <div className="lg:col-span-8 space-y-6">
                    <Card className="rounded-3xl border-zinc-200 shadow-xl overflow-hidden border-t-4 border-t-orange-500">
                        ...
                        <CardFooter className="bg-zinc-50 border-t border-zinc-100 p-6 flex justify-between">
                            <Button variant="ghost" onClick={addMeal} className="rounded-xl font-bold text-gray-500 hover:text-orange-600">
                            ...
                            <form action={async () => {
                                ...
                                <Button type="submit" className="bg-zinc-900 hover:bg-zinc-800 h-12 px-8 rounded-2xl font-bold shadow-lg shadow-zinc-200">
                                    Update Plan
                                </Button>
                            </form>
                        </CardFooter>
                ...
                <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-8">
                        ...
                        <CardContent className="space-y-6">
                            <div className="space-y-2">
                                <div className="flex justify-between items-end">
                                    <span className="text-sm font-bold text-gray-500">Protein</span>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-end">
                                    <span className="text-sm font-bold text-gray-500">Carbs</span>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-end">
                                    <span className="text-sm font-bold text-gray-500">Fats</span>
                    ...
                    <div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-5 flex gap-4">
                        <Info className="h-5 w-5 text-gray-400 shrink-0 mt-0.5" />
                        <p className="text-xs font-medium text-gray-500 leading-relaxed">
                            Updating this template will not automatically change previously assigned plans to athletes.
                        </p>
                    </div>
                </div>
            </div>
